  ...
  return (
    <ScrollView style={{ backgroundColor: '#F3F3F4' }}>
      <View style={{ padding: 20 }}>
        ...
        <TouchableOpacity
          onPress={() => {
            getConsultationList(39, 1, 20).then((res) => {
              console.log(res);
            });
          }}
          style={styles.button}
        ...
        <View style={{ flexDirection: 'row' }}>
          <TextInput
            ...
            onChangeText={(idText) => setDeleteConsultationId(idText)}
          />
          <TouchableOpacity
            onPress={() => {
              ...
              deleteConsultation(deleteConsultationId).then((res) => {
                console.log(res);
              });
            }}
            style={styles.button}
        ...
        <View style={{ flexDirection: 'row' }}>
          <TextInput
            ...
            onChangeText={(idText) => setGetConsultationId(idText)}
          />
          <TouchableOpacity
            onPress={() => {
              ...
              getConsultationInfo(getConsultationId).then((res) => {
                console.log(res);
              });
            }}
            style={styles.button}
        ...
        <TouchableOpacity
          onPress={() => {
            getPrescription(230).then(async (response) => {
              ...
              const filePath =
                DownloadDir + '/prescription' + new Date().getTime() + '.pdf';
